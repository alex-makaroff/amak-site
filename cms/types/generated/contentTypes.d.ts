...
export interface ApiCaseCase extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<['website', 'design']> & Attribute.Required;
    badge: Attribute.String & Attribute.Required;
    excerpt: Attribute.Text;
    description: Attribute.RichText;
    cover: Attribute.Media<'images'> & Attribute.Required;
    coverAlt: Attribute.String;
    isFeatured: Attribute.Boolean & Attribute.DefaultTo<false>;
    featuredRank: Attribute.Integer;
    sortRank: Attribute.Integer;
    details: Attribute.DynamicZone<
      ['case.website-details', 'case.design-details']
    > &
      Attribute.Required &
      Attribute.SetMinMax<
        {
...
export interface ApiCasesPageCasesPage extends Schema.SingleType {
...
export interface ApiHomepageHomepage extends Schema.SingleType {
  ...
  attributes: {
    featuredTitle: Attribute.String &
      Attribute.DefaultTo<'\u0418\u0437\u0431\u0440\u0430\u043D\u043D\u044B\u0435 \u043A\u0435\u0439\u0441\u044B'>;
